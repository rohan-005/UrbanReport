...
export default function AdminLoginPage() {
  ...
  return (
    <Box sx={{ minHeight: 'calc(100vh - 4rem)', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5f3ee', py: { xs: 4, md: 8 }, px: 2 }}>
      <Box sx={{ width: '100%', maxWidth: '960px', display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1.1fr' }, backgroundColor: '#ffffff', borderRadius: '4px', border: '1px solid #e2e0d8', shadow: '0 20px 25px -5px rgba(0, 0, 0, 0.05)', overflow: 'hidden' }}>
        ...
        <Box sx={{ p: { xs: 4, md: 6 }, backgroundColor: '#09090b', color: '#ffffff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <Box>
            ...
            <Box sx={{ mt: 5, mb: 4 }}>
              <Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 1, px: 1.5, py: 0.5, backgroundColor: '#18181b', border: '1px solid #27272a', borderRadius: '2px', mb: 2 }}>
                <ShieldCheck className="w-4 h-4 text-emerald-400" />
                <Typography variant="caption" sx={{ color: '#a1a1aa', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                  Municipal Authority Portal
                </Typography>
              </Box>
              <Typography variant="h4" sx={{ fontWeight: 900, textTransform: 'uppercase', mb: 1.5, fontSize: { xs: '1.5rem', md: '1.875rem' }, lineHeight: 1.2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 3, borderTop: '1px solid #27272a' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                <Building2 className="w-4 h-4 text-zinc-400 shrink-0" />
                <Typography variant="caption" sx={{ color: '#d4d4d8', fontWeight: 600 }}>
          ...
          <Box sx={{ mt: 6, pt: 3, borderTop: '1px solid #27272a', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Typography variant="caption" sx={{ color: '#71717a', fontWeight: 700, fontFamily: 'monospace' }}>
              RBAC PROTECTED
            </Typography>
          </Box>
        </Box>
        ...
        <Box component="form" onSubmit={handleAdminLogin} sx={{ p: { xs: 4, sm: 6 }, display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#ffffff' }}>
          <Box sx={{ mb: 3 }}>
            <Typography variant="h5" sx={{ fontWeight: 900, color: '#09090b', mb: 0.5 }}>
          ...
          {errorMessage && (
            <Alert severity="error" sx={{ mb: 3, borderRadius: '2px', fontWeight: 600 }}>
              {errorMessage}
            </Alert>
          )}
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            ...
            <Box sx={{ pt: 3, mt: 2, borderTop: '1px solid #e2e0d8', textAlign: 'center' }}>
              <Typography variant="caption" sx={{ color: '#71717a', fontWeight: 600 }}>
                Citizen user?{' '}
                <Link href="/login" className="font-bold text-zinc-950 underline hover:text-black">
